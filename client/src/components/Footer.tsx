...
export default function Footer() {
  return (
    <footer className="bg-solana-dark border-t border-solana-dark-light py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            <svg className="h-6 w-6 text-solana-secondary" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="ml-2 text-white font-medium">SolFlow</span>
          </div>
          ...
          <div className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} SolFlow. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
